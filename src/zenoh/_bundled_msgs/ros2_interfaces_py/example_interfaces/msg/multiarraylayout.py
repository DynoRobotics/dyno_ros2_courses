...
@dataclass
class MultiArrayLayout(IdlStruct, typename="example_interfaces/MultiArrayLayout"):

    """example_interfaces/MultiArrayLayout message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_7af7fcc3a9f9ac3fd509097b7bbd8d83cb5fdc89d17cb8faf5d3f55f94c5010c


    DDS type name: example_interfaces::msg::dds_::MultiArrayLayout_
    ...
    TYPE_HASH = "RIHS01_7af7fcc3a9f9ac3fd509097b7bbd8d83cb5fdc89d17cb8faf5d3f55f94c5010c"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::MultiArrayLayout_"
    ...
    def to_dict(self) -> dict:
        ...
        result['dim'] = [item.to_dict() for item in self.dim]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'dim' in data:
            ...
            kwargs['dim'] = [MultiArrayDimension.from_dict(item) for item in data['dim']]


        if 'data_offset' in data:

            kwargs['data_offset'] = data['data_offset']
