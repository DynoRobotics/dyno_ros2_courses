...
@dataclass
class WString(IdlStruct, typename="example_interfaces/WString"):

    """example_interfaces/WString message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_32033e06d9dfe5468c5d6e1dc8b7a23c8910bad071cfd4e151a951d580e68dd8


    DDS type name: example_interfaces::msg::dds_::WString_
    ...
    TYPE_HASH = "RIHS01_32033e06d9dfe5468c5d6e1dc8b7a23c8910bad071cfd4e151a951d580e68dd8"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::WString_"
