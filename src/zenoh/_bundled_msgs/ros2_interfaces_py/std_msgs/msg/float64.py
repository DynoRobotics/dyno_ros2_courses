...
class Float64(IdlStruct, typename="std_msgs/Float64"):
    ...
    ROS 2 type hash: RIHS01_705ba9c3d1a09df43737eb67095534de36fd426c0587779bda2bc51fe790182a


    DDS type name: std_msgs::msg::dds_::Float64_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::Float64_"
