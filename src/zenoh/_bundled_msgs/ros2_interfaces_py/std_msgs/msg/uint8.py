...
class UInt8(IdlStruct, typename="std_msgs/UInt8"):
    ...
    ROS 2 type hash: RIHS01_6138bd83d8c3569cb80a667db03cfc1629f529fee79d944c39c34e352e72f010


    DDS type name: std_msgs::msg::dds_::UInt8_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::UInt8_"
