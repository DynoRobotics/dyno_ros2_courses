...
class ColorRGBA(IdlStruct, typename="std_msgs/ColorRGBA"):
    ...
    ROS 2 type hash: RIHS01_77a7a5b9ae477306097665106e0413ba74440245b1f3d0c6d6405fe5c7813fe8


    DDS type name: std_msgs::msg::dds_::ColorRGBA_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::ColorRGBA_"
