...
@dataclass
class PolygonInstanceStamped(IdlStruct, typename="geometry_msgs/PolygonInstanceStamped"):

    """geometry_msgs/PolygonInstanceStamped message.
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::PolygonInstanceStamped_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'polygon' in data:
            ...
            kwargs['polygon'] = PolygonInstance.from_dict(data['polygon'])
