...
@dataclass
class ListParametersResult(IdlStruct, typename="rcl_interfaces/ListParametersResult"):

    """rcl_interfaces/ListParametersResult message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_5c95d27b6eb29d410359ef95ae026c2b00284365eb123a36959951414e2730e6


    DDS type name: rcl_interfaces::msg::dds_::ListParametersResult_
    ...
    TYPE_HASH = "RIHS01_5c95d27b6eb29d410359ef95ae026c2b00284365eb123a36959951414e2730e6"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::msg::dds_::ListParametersResult_"
