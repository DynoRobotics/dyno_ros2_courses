...
@dataclass
class SetParametersResult(IdlStruct, typename="rcl_interfaces/SetParametersResult"):

    """rcl_interfaces/SetParametersResult message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_cfcc0fb0371ee5159b403960ef4300f8f9d2f1fd6117c8666b7f9654d528a9b1


    DDS type name: rcl_interfaces::msg::dds_::SetParametersResult_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::msg::dds_::SetParametersResult_"
