...
@dataclass
class LoggerLevel(IdlStruct, typename="rcl_interfaces/LoggerLevel"):

    """rcl_interfaces/LoggerLevel message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_95785cc42f048ab4f395af65035aeaf2181d8e1c7a44edb8ad4558445fdb43c0


    DDS type name: rcl_interfaces::msg::dds_::LoggerLevel_
    ...
    TYPE_HASH = "RIHS01_95785cc42f048ab4f395af65035aeaf2181d8e1c7a44edb8ad4558445fdb43c0"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::msg::dds_::LoggerLevel_"
