...
@dataclass
class IntegerRange(IdlStruct, typename="rcl_interfaces/IntegerRange"):

    """rcl_interfaces/IntegerRange message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_f7b7fdc0f65f07702e099218e13288c3963bcb9345bde78b560e6cd19800fc5a


    DDS type name: rcl_interfaces::msg::dds_::IntegerRange_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::msg::dds_::IntegerRange_"
