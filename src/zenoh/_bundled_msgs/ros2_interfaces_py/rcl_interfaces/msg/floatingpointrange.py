...
@dataclass
class FloatingPointRange(IdlStruct, typename="rcl_interfaces/FloatingPointRange"):

    """rcl_interfaces/FloatingPointRange message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_e6af23a23c177fee5f3075c8b1e435162a9b63c863d78c06017460b49684262d


    DDS type name: rcl_interfaces::msg::dds_::FloatingPointRange_

    """

    from_value: float64 = 0.0

    to_value: float64 = 0.0
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::msg::dds_::FloatingPointRange_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'from_value' in data:
            ...
            kwargs['from_value'] = data['from_value']


        if 'to_value' in data:

            kwargs['to_value'] = data['to_value']
