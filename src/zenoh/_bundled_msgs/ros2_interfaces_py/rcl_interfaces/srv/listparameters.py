"""
ListParameters service type.

Auto-generated from rcl_interfaces/srv/ListParameters.srv
"""
...
from ..msg.listparametersresult import ListParametersResult
...
class ListParameters_Request(IdlStruct, typename="rcl_interfaces/ListParameters_Request"):
    ...
    ROS 2 type hash: RIHS01_fa9730c7be979b43eeb894fe1c11a858e8f21ee97ac6f557279da8d092249357
    ...
    TYPE_HASH = "RIHS01_fa9730c7be979b43eeb894fe1c11a858e8f21ee97ac6f557279da8d092249357"
...
@dataclass
class ListParameters_Response(IdlStruct, typename="rcl_interfaces/ListParameters_Response"):

    """rcl_interfaces/ListParameters_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_5b78f1de23b26a175edcf3d2000a5ee74b94700d39228275f0d05535e841c9bd


    DDS type name: rcl_interfaces::srv::dds_::ListParameters_Response_
    ...
    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_5b78f1de23b26a175edcf3d2000a5ee74b94700d39228275f0d05535e841c9bd"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::ListParameters_Response_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'result' in data:
            ...
            kwargs['result'] = ListParametersResult.from_dict(data['result'])
...
class ListParameters:
    """
    Service type for rcl_interfaces/ListParameters.
