...
@dataclass
class UInt32(IdlStruct, typename="example_interfaces/UInt32"):

    """example_interfaces/UInt32 message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_e86cccba586f30c16498f3ccd3550a764b255239a6142be3a4d7a2fa9a43515c


    DDS type name: example_interfaces::msg::dds_::UInt32_
    ...
    TYPE_HASH = "RIHS01_e86cccba586f30c16498f3ccd3550a764b255239a6142be3a4d7a2fa9a43515c"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::UInt32_"
