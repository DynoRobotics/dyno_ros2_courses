...
@dataclass
class Empty(IdlStruct, typename="example_interfaces/Empty"):

    """example_interfaces/Empty message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_bd4869c70af98465c9501add69cf18360c0a19d14a5a1ed8cd928ed8b632f035


    DDS type name: example_interfaces::msg::dds_::Empty_
    ...
    TYPE_HASH = "RIHS01_bd4869c70af98465c9501add69cf18360c0a19d14a5a1ed8cd928ed8b632f035"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::Empty_"
