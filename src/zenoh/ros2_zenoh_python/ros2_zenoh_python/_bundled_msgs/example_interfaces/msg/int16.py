...
@dataclass
class Int16(IdlStruct, typename="example_interfaces/Int16"):

    """example_interfaces/Int16 message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_332d94306732e4e35da38e5ae744ff35bbdaeca300908dc43488d3a844687cd6


    DDS type name: example_interfaces::msg::dds_::Int16_
    ...
    TYPE_HASH = "RIHS01_332d94306732e4e35da38e5ae744ff35bbdaeca300908dc43488d3a844687cd6"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::Int16_"
