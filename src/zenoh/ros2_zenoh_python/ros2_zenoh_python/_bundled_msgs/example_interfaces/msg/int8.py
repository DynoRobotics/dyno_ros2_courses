...
@dataclass
class Int8(IdlStruct, typename="example_interfaces/Int8"):

    """example_interfaces/Int8 message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_2e9ef643d84ff37840fe787d1269aa06268960e294f4a0f5eb1e9d4eb21cbb57


    DDS type name: example_interfaces::msg::dds_::Int8_
    ...
    TYPE_HASH = "RIHS01_2e9ef643d84ff37840fe787d1269aa06268960e294f4a0f5eb1e9d4eb21cbb57"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::Int8_"
