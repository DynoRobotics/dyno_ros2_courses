...
@dataclass
class UInt8(IdlStruct, typename="example_interfaces/UInt8"):

    """example_interfaces/UInt8 message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_9255b6d0dd98f5b573afbff223131279b788ac45cf051fb462c12dd9a30f4061


    DDS type name: example_interfaces::msg::dds_::UInt8_
    ...
    TYPE_HASH = "RIHS01_9255b6d0dd98f5b573afbff223131279b788ac45cf051fb462c12dd9a30f4061"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::UInt8_"
