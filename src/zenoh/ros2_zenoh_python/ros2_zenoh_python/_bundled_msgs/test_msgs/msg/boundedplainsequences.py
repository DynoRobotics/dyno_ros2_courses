...
@dataclass
class BoundedPlainSequences(IdlStruct, typename="test_msgs/BoundedPlainSequences"):

    """test_msgs/BoundedPlainSequences message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_3c9ee65963ad9ce648ebaa4b825ce1f418226ed8bbfcfb27fd748ba44b71c52a


    DDS type name: test_msgs::msg::dds_::BoundedPlainSequences_
    ...
    TYPE_HASH = "RIHS01_3c9ee65963ad9ce648ebaa4b825ce1f418226ed8bbfcfb27fd748ba44b71c52a"


    # DDS Type Name
    DDS_TYPE_NAME = "test_msgs::msg::dds_::BoundedPlainSequences_"
