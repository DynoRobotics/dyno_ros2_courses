...
@dataclass
class Defaults(IdlStruct, typename="test_msgs/Defaults"):

    """test_msgs/Defaults message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_556d5d6acea1ceb2027a69f8be85e323851e87b1fbc54eacbbd9bad5a147ba03


    DDS type name: test_msgs::msg::dds_::Defaults_
    ...
    char_value: uint8 = 100

    float32_value: float32 = 1.125

    float64_value: float64 = 1.125

    int8_value: int8 = -50

    uint8_value: uint8 = 200

    int16_value: int16 = -1000

    uint16_value: uint16 = 2000

    int32_value: int32 = -30000

    uint32_value: uint32 = 60000

    int64_value: int64 = -40000000

    uint64_value: uint64 = 50000000

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_556d5d6acea1ceb2027a69f8be85e323851e87b1fbc54eacbbd9bad5a147ba03"


    # DDS Type Name
    DDS_TYPE_NAME = "test_msgs::msg::dds_::Defaults_"
