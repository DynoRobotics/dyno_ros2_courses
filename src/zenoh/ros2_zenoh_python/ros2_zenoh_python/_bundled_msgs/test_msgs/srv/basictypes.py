...
Auto-generated from test_msgs/srv/BasicTypes.srv
"""
...
@dataclass
class BasicTypes_Request(IdlStruct, typename="test_msgs/BasicTypes_Request"):

    """test_msgs/BasicTypes_Request message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_73a495742f5b4fe2bd2a1d4b6574ede3ebf3864cde679f2aa501250a52b6b7d5


    DDS type name: test_msgs::srv::dds_::BasicTypes_Request_
    ...
    TYPE_HASH = "RIHS01_73a495742f5b4fe2bd2a1d4b6574ede3ebf3864cde679f2aa501250a52b6b7d5"


    # DDS Type Name
    DDS_TYPE_NAME = "test_msgs::srv::dds_::BasicTypes_Request_"
...
@dataclass
class BasicTypes_Response(IdlStruct, typename="test_msgs/BasicTypes_Response"):

    """test_msgs/BasicTypes_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_63bd25f085254cce4e05f1bef688ea581dc1c4e886075ea51bacfbb4da0e6b2a


    DDS type name: test_msgs::srv::dds_::BasicTypes_Response_
    ...
    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_63bd25f085254cce4e05f1bef688ea581dc1c4e886075ea51bacfbb4da0e6b2a"


    # DDS Type Name
    DDS_TYPE_NAME = "test_msgs::srv::dds_::BasicTypes_Response_"
...
class BasicTypes:
    """
    Service type for test_msgs/BasicTypes.
    
    Request: BasicTypes_Request
    Response: BasicTypes_Response
    """
    Request = BasicTypes_Request
    Response = BasicTypes_Response
    
    # ROS2 Service Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_5e8ba476da5e41814e98fa27612489d534e9c0ae50d90c795154583dcc6ab931"
