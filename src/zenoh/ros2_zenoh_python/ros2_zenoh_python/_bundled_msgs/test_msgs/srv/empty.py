...
Auto-generated from test_msgs/srv/Empty.srv
"""
...
@dataclass
class Empty_Request(IdlStruct, typename="test_msgs/Empty_Request"):

    """test_msgs/Empty_Request message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_95c8ed0e77dbea3f4669eb6b41b6ae60153d6d866d0b69d0f9392980eb52c535


    DDS type name: test_msgs::srv::dds_::Empty_Request_
    ...
    TYPE_HASH = "RIHS01_95c8ed0e77dbea3f4669eb6b41b6ae60153d6d866d0b69d0f9392980eb52c535"


    # DDS Type Name
    DDS_TYPE_NAME = "test_msgs::srv::dds_::Empty_Request_"
...
@dataclass
class Empty_Response(IdlStruct, typename="test_msgs/Empty_Response"):

    """test_msgs/Empty_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_197e6a29c00fba1e2b5f0ebf292b9980a245f713d5a7d869d72b4ceb1a9de986


    DDS type name: test_msgs::srv::dds_::Empty_Response_
    ...
    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_197e6a29c00fba1e2b5f0ebf292b9980a245f713d5a7d869d72b4ceb1a9de986"


    # DDS Type Name
    DDS_TYPE_NAME = "test_msgs::srv::dds_::Empty_Response_"
...
class Empty:
    """
    Service type for test_msgs/Empty.
    ...
    TYPE_HASH = "RIHS01_459c82551c238f53ab1931faf71c37710b40e0e7954bb25a3b9361610aed6b0e"
