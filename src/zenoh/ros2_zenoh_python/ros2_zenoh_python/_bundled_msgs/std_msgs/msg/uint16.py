...
class UInt16(IdlStruct, typename="std_msgs/UInt16"):
    ...
    ROS 2 type hash: RIHS01_08a406e4b022bc22e907f985d6a9e9dd1d4fbecae573549cf49350113e7757b1


    DDS type name: std_msgs::msg::dds_::UInt16_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::UInt16_"
