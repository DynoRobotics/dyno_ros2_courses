...
class Float32(IdlStruct, typename="std_msgs/Float32"):
    ...
    ROS 2 type hash: RIHS01_7170d3d8f841f7be3172ce5f4f59f3a4d7f63b0447e8b33327601ad64d83d6e2


    DDS type name: std_msgs::msg::dds_::Float32_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::Float32_"
