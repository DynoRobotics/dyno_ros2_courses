...
class Bool(IdlStruct, typename="std_msgs/Bool"):
    ...
    ROS 2 type hash: RIHS01_feb91e995ff9ebd09c0cb3d2aed18b11077585839fb5db80193b62d74528f6c9


    DDS type name: std_msgs::msg::dds_::Bool_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::Bool_"
