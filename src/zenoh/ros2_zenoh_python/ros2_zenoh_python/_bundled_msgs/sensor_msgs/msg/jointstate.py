...
class JointState(IdlStruct, typename="sensor_msgs/JointState"):
    ...
    ROS 2 type hash: RIHS01_a13ee3a330e346c9d87b5aa18d24e11690752bd33a0350f11c5882bc9179260e


    DDS type name: sensor_msgs::msg::dds_::JointState_
    ...
    position: List[float64] = field(default_factory=list)

    velocity: List[float64] = field(default_factory=list)

    effort: List[float64] = field(default_factory=list)
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::JointState_"
