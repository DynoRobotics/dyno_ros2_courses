...
class MultiEchoLaserScan(IdlStruct, typename="sensor_msgs/MultiEchoLaserScan"):
    ...
    ROS 2 type hash: RIHS01_ba5eac341cd5bbb2701527aa4568e8baec172b69cadb9a1945d6f149d087ee48


    DDS type name: sensor_msgs::msg::dds_::MultiEchoLaserScan_
    ...
    ranges: List[LaserEcho] = field(default_factory=list)

    intensities: List[LaserEcho] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_ba5eac341cd5bbb2701527aa4568e8baec172b69cadb9a1945d6f149d087ee48"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::MultiEchoLaserScan_"
    ...
    def to_dict(self) -> dict:
        ...
        result['ranges'] = [item.to_dict() for item in self.ranges]



        result['intensities'] = [item.to_dict() for item in self.intensities]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'ranges' in data:
            ...
            kwargs['ranges'] = [LaserEcho.from_dict(item) for item in data['ranges']]
        ...
        if 'intensities' in data:
            ...
            kwargs['intensities'] = [LaserEcho.from_dict(item) for item in data['intensities']]
