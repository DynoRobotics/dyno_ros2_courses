...
class PointCloud(IdlStruct, typename="sensor_msgs/PointCloud"):
    ...
    ROS 2 type hash: RIHS01_614593df71d3c2b9bd4604a71b750fd218f0d65c045ea988b713719455a65b3b


    DDS type name: sensor_msgs::msg::dds_::PointCloud_
    ...
    points: List[geometry_msgs_msg.Point32] = field(default_factory=list)

    channels: List[ChannelFloat32] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_614593df71d3c2b9bd4604a71b750fd218f0d65c045ea988b713719455a65b3b"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::PointCloud_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'points' in data:
            ...
            kwargs['points'] = [geometry_msgs_msg.Point32.from_dict(item) for item in data['points']]
        ...
        if 'channels' in data:
            ...
            kwargs['channels'] = [ChannelFloat32.from_dict(item) for item in data['channels']]
