...
class TimeReference(IdlStruct, typename="sensor_msgs/TimeReference"):
    ...
    ROS 2 type hash: RIHS01_dd66e84cf40bbb5d5a40472e6ecf2675a031334d4c426abdb2ad41801a8efc99


    DDS type name: sensor_msgs::msg::dds_::TimeReference_
    ...
    time_ref: builtin_interfaces_msg.Time = field(default_factory=lambda: builtin_interfaces_msg.Time())
    ...
    TYPE_HASH = "RIHS01_dd66e84cf40bbb5d5a40472e6ecf2675a031334d4c426abdb2ad41801a8efc99"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::TimeReference_"
    ...
    def to_dict(self) -> dict:
        ...
        result['time_ref'] = self.time_ref.to_dict()
    ...
    def from_dict(cls, data: dict):
        ...
        if 'time_ref' in data:
            ...
            kwargs['time_ref'] = builtin_interfaces_msg.Time.from_dict(data['time_ref'])
