...
class LaserEcho(IdlStruct, typename="sensor_msgs/LaserEcho"):
    ...
    ROS 2 type hash: RIHS01_0fbc05a0db7d37fe52c0f0375356db55da0046f7ef5bd27ca6b34bd0582bc952


    DDS type name: sensor_msgs::msg::dds_::LaserEcho_

    """


    echoes: List[float32] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_0fbc05a0db7d37fe52c0f0375356db55da0046f7ef5bd27ca6b34bd0582bc952"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::LaserEcho_"
