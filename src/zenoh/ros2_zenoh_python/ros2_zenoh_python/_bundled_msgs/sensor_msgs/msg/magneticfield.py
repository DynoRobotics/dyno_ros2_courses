...
class MagneticField(IdlStruct, typename="sensor_msgs/MagneticField"):
    ...
    ROS 2 type hash: RIHS01_e80f32f56a20486c9923008fc1a1db07bbb273cbbf6a5b3bfa00835ee00e4dff


    DDS type name: sensor_msgs::msg::dds_::MagneticField_
    ...
    magnetic_field: geometry_msgs_msg.Vector3 = field(default_factory=lambda: geometry_msgs_msg.Vector3())

    magnetic_field_covariance: array[float64, 9] = field(default_factory=lambda: [0.0] * 9)
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::MagneticField_"
    ...
    def to_dict(self) -> dict:
        ...
        result['magnetic_field'] = self.magnetic_field.to_dict()



        result['magnetic_field_covariance'] = self.magnetic_field_covariance
    ...
    def from_dict(cls, data: dict):
        ...
        if 'magnetic_field' in data:
            ...
            kwargs['magnetic_field'] = geometry_msgs_msg.Vector3.from_dict(data['magnetic_field'])
            


        if 'magnetic_field_covariance' in data:

            kwargs['magnetic_field_covariance'] = data['magnetic_field_covariance']
