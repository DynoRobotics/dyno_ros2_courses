...
@dataclass
class GoalStatusArray(IdlStruct, typename="action_msgs/GoalStatusArray"):

    """action_msgs/GoalStatusArray message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_6c1684b00f177d37438febe6e709fc4e2b0d4248dca4854946f9ed8b30cda83e


    DDS type name: action_msgs::msg::dds_::GoalStatusArray_

    """


    status_list: List[GoalStatus] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_6c1684b00f177d37438febe6e709fc4e2b0d4248dca4854946f9ed8b30cda83e"


    # DDS Type Name
    DDS_TYPE_NAME = "action_msgs::msg::dds_::GoalStatusArray_"
    ...
    def to_dict(self) -> dict:
        ...
        result['status_list'] = [item.to_dict() for item in self.status_list]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'status_list' in data:
            ...
            kwargs['status_list'] = [GoalStatus.from_dict(item) for item in data['status_list']]
