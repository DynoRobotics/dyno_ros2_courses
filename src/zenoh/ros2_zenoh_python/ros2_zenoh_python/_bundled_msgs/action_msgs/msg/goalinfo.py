...
from ...unique_identifier_msgs import msg as unique_identifier_msgs_msg
...
@dataclass
class GoalInfo(IdlStruct, typename="action_msgs/GoalInfo"):

    """action_msgs/GoalInfo message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_6398fe763154554353930716b225947f93b672f0fb2e49fdd01bb7a7e37933e9


    DDS type name: action_msgs::msg::dds_::GoalInfo_

    """


    goal_id: unique_identifier_msgs_msg.UUID = field(default_factory=lambda: unique_identifier_msgs_msg.UUID())
    ...
    TYPE_HASH = "RIHS01_6398fe763154554353930716b225947f93b672f0fb2e49fdd01bb7a7e37933e9"


    # DDS Type Name
    DDS_TYPE_NAME = "action_msgs::msg::dds_::GoalInfo_"
