...
class QuaternionStamped(IdlStruct, typename="geometry_msgs/QuaternionStamped"):
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::QuaternionStamped_"
    ...
    def to_dict(self) -> dict:
        ...
        result['quaternion'] = self.quaternion.to_dict()
    ...
    def from_dict(cls, data: dict):
        ...
        if 'quaternion' in data:
            ...
            kwargs['quaternion'] = Quaternion.from_dict(data['quaternion'])
