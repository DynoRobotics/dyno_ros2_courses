...
class AccelWithCovarianceStamped(IdlStruct, typename="geometry_msgs/AccelWithCovarianceStamped"):
    ...
    ROS 2 type hash: RIHS01_61c9ad8928e71dd95ce791b2f02809ee2a0bbcc42cd0e4047fd00a822a08e444


    DDS type name: geometry_msgs::msg::dds_::AccelWithCovarianceStamped_
    ...
    TYPE_HASH = "RIHS01_61c9ad8928e71dd95ce791b2f02809ee2a0bbcc42cd0e4047fd00a822a08e444"


    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::AccelWithCovarianceStamped_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'accel' in data:
            ...
            kwargs['accel'] = AccelWithCovariance.from_dict(data['accel'])
