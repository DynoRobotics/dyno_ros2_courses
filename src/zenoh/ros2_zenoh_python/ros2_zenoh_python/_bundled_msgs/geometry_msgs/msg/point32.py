...
class Point32(IdlStruct, typename="geometry_msgs/Point32"):
    ...
    ROS 2 type hash: RIHS01_2fc4db7cae16a4582c79a56b66173a8d48d52c7dc520ddc55a0d4bcf2a4bfdbc


    DDS type name: geometry_msgs::msg::dds_::Point32_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::Point32_"
