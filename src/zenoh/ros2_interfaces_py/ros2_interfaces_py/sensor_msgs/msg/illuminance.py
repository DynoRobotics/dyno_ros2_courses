...
class Illuminance(IdlStruct, typename="sensor_msgs/Illuminance"):
    ...
    """sensor_msgs/Illuminance message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_1b3d419fdf426f329939d83956703b3987a1bf53703a382a94340cd1d41792a2


    DDS type name: sensor_msgs::msg::dds_::Illuminance_
    ...
    TYPE_HASH = "RIHS01_1b3d419fdf426f329939d83956703b3987a1bf53703a382a94340cd1d41792a2"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::Illuminance_"
    ...
    def to_dict(self) -> dict:
        ...
        result['illuminance'] = self.illuminance
    ...
    def from_dict(cls, data: dict):
        ...
        if 'illuminance' in data:
            ...
            kwargs['illuminance'] = data['illuminance']
