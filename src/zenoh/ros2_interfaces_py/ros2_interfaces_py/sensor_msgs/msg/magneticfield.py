...
class MagneticField(IdlStruct, typename="sensor_msgs/MagneticField"):
    ...
    ROS 2 type hash: RIHS01_3efcf2cb337e41909efe5e35130fdad7eac97e87e4578b03bf68df7388d6a94d
    ...
    magnetic_field: 'ros2_interfaces_py.geometry_msgs.msg.Vector3'

    magnetic_field_covariance: List[float64]

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_3efcf2cb337e41909efe5e35130fdad7eac97e87e4578b03bf68df7388d6a94d"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'magnetic_field' in data:
            ...
            kwargs['magnetic_field'] = Vector3.from_dict(data['magnetic_field'])
