...
class FluidPressure(IdlStruct, typename="sensor_msgs/FluidPressure"):
    ...
    ROS 2 type hash: RIHS01_4b7724c169a0daecb12b050c5662a696845ca4e7fbc346aaa5be811a2e1dbaae


    DDS type name: sensor_msgs::msg::dds_::FluidPressure_
    ...
    TYPE_HASH = "RIHS01_4b7724c169a0daecb12b050c5662a696845ca4e7fbc346aaa5be811a2e1dbaae"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::FluidPressure_"
    ...
    def to_dict(self) -> dict:
        ...
        result['fluid_pressure'] = self.fluid_pressure
    ...
    def from_dict(cls, data: dict):
        ...
        if 'fluid_pressure' in data:

            kwargs['fluid_pressure'] = data['fluid_pressure']
