...
class RegionOfInterest(IdlStruct, typename="sensor_msgs/RegionOfInterest"):
    ...
    ROS 2 type hash: RIHS01_ad16bcba5f9131dcdba6fbded19f726f5440e3c513b4fb586dd3027eeed8abb1


    DDS type name: sensor_msgs::msg::dds_::RegionOfInterest_
    ...
    TYPE_HASH = "RIHS01_ad16bcba5f9131dcdba6fbded19f726f5440e3c513b4fb586dd3027eeed8abb1"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::RegionOfInterest_"
    ...
    def to_dict(self) -> dict:
        ...
        result['do_rectify'] = self.do_rectify
    ...
    def from_dict(cls, data: dict):
        ...
        if 'x_offset' in data:
            ...
            kwargs['x_offset'] = data['x_offset']


        if 'y_offset' in data:

            kwargs['y_offset'] = data['y_offset']
        ...
        if 'do_rectify' in data:

            kwargs['do_rectify'] = data['do_rectify']
