...
class MultiDOFJointState(IdlStruct, typename="sensor_msgs/MultiDOFJointState"):
    ...
    ROS 2 type hash: RIHS01_528f3ea27edd14c2893527137d27373058150289e7b2b3de01667736e5f9e63d
    ...
    twist: List['ros2_interfaces_py.geometry_msgs.msg.Twist']

    wrench: List['ros2_interfaces_py.geometry_msgs.msg.Wrench']

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_528f3ea27edd14c2893527137d27373058150289e7b2b3de01667736e5f9e63d"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'twist' in data:
            ...
            kwargs['twist'] = [Twist.from_dict(item) for item in data['twist']]


        if 'wrench' in data:

            kwargs['wrench'] = [Wrench.from_dict(item) for item in data['wrench']]
