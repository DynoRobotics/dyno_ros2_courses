...
class JoyFeedback(IdlStruct, typename="sensor_msgs/JoyFeedback"):
    ...
    """sensor_msgs/JoyFeedback message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_231dd362f71d6fc08272770d07120ad5fe5874ce2dbac70109b28986834290cd


    DDS type name: sensor_msgs::msg::dds_::JoyFeedback_
    ...
    TYPE_HASH = "RIHS01_231dd362f71d6fc08272770d07120ad5fe5874ce2dbac70109b28986834290cd"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::JoyFeedback_"
