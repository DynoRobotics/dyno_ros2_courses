...
class TimeReference(IdlStruct, typename="sensor_msgs/TimeReference"):
    ...
    ROS 2 type hash: RIHS01_db386227e42d4e487f0528096c9c423333b6951a0b1b471c3ce182bc3db49e0e
    ...
    time_ref: 'ros2_interfaces_py.builtin_interfaces.msg.Time'
    ...
    TYPE_HASH = "RIHS01_db386227e42d4e487f0528096c9c423333b6951a0b1b471c3ce182bc3db49e0e"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'time_ref' in data:
            ...
            kwargs['time_ref'] = Time.from_dict(data['time_ref'])
