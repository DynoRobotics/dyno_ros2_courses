"""
SetLoggerLevels service type.

Auto-generated from rcl_interfaces/srv/SetLoggerLevels.srv
"""
...
from ..msg.setloggerlevelsresult import SetLoggerLevelsResult
...
class SetLoggerLevels_Request(IdlStruct, typename="rcl_interfaces/SetLoggerLevels_Request"):
    ...
    ROS 2 type hash: RIHS01_053c4c293227f8a1bc166e7161be664345172a455893a446a68b527216ecd3ce
    ...
    TYPE_HASH = "RIHS01_053c4c293227f8a1bc166e7161be664345172a455893a446a68b527216ecd3ce"
...
@dataclass
class SetLoggerLevels_Response(IdlStruct, typename="rcl_interfaces/SetLoggerLevels_Response"):

    """rcl_interfaces/SetLoggerLevels_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_5877c732664311d8cb58a9532fec9cadb63e14356f11f6bff0ee881cc2666dac


    DDS type name: rcl_interfaces::srv::dds_::SetLoggerLevels_Response_

    """

    results: List[SetLoggerLevelsResult] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_5877c732664311d8cb58a9532fec9cadb63e14356f11f6bff0ee881cc2666dac"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::SetLoggerLevels_Response_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'results' in data:
            ...
            kwargs['results'] = [SetLoggerLevelsResult.from_dict(item) for item in data['results']]
...
class SetLoggerLevels:
    """
    Service type for rcl_interfaces/SetLoggerLevels.
    ...
    TYPE_HASH = "RIHS01_3f9f2b66cd794a248477d7293c0289a80b45b63425ece2ab63f014524fb958ee"
