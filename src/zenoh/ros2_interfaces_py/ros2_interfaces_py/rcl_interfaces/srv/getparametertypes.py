...
Auto-generated from rcl_interfaces/srv/GetParameterTypes.srv
"""
...
@dataclass
class GetParameterTypes_Request(IdlStruct, typename="rcl_interfaces/GetParameterTypes_Request"):

    """rcl_interfaces/GetParameterTypes_Request message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_49d93934980b27aebf592289e1cff7a33df42e1551acc00d4692c979c205c4fc


    DDS type name: rcl_interfaces::srv::dds_::GetParameterTypes_Request_
    ...
    TYPE_HASH = "RIHS01_49d93934980b27aebf592289e1cff7a33df42e1551acc00d4692c979c205c4fc"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::GetParameterTypes_Request_"
...
@dataclass
class GetParameterTypes_Response(IdlStruct, typename="rcl_interfaces/GetParameterTypes_Response"):

    """rcl_interfaces/GetParameterTypes_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_5dc23cb597cf468eb13b35e0015688f74ffa4b6f7661e24bef588d3f8fafe4ec


    DDS type name: rcl_interfaces::srv::dds_::GetParameterTypes_Response_

    """

    types: List[uint8] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_5dc23cb597cf468eb13b35e0015688f74ffa4b6f7661e24bef588d3f8fafe4ec"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::GetParameterTypes_Response_"
...
class GetParameterTypes:
    """
    Service type for rcl_interfaces/GetParameterTypes.
    ...
    TYPE_HASH = "RIHS01_63d95b89923e9f6c8dc3a9b9683f2a242d122eb220c6497bf02c99c747c569d5"
