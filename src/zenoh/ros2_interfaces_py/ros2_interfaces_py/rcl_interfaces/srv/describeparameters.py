"""
DescribeParameters service type.

Auto-generated from rcl_interfaces/srv/DescribeParameters.srv
"""
...
from ..msg.parameterdescriptor import ParameterDescriptor
...
@dataclass
class DescribeParameters_Request(IdlStruct, typename="rcl_interfaces/DescribeParameters_Request"):

    """rcl_interfaces/DescribeParameters_Request message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_1e880ba8602a1fe7a53ea7138365cb11f10a1f5c2fdb8efc55ab14aaf8e882b9


    DDS type name: rcl_interfaces::srv::dds_::DescribeParameters_Request_
    ...
    TYPE_HASH = "RIHS01_1e880ba8602a1fe7a53ea7138365cb11f10a1f5c2fdb8efc55ab14aaf8e882b9"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::DescribeParameters_Request_"
...
@dataclass
class DescribeParameters_Response(IdlStruct, typename="rcl_interfaces/DescribeParameters_Response"):

    """rcl_interfaces/DescribeParameters_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_f78abb00c23f3de0d89855f2fde1edf956df5996848e9bdf2c1800ee577b0188


    DDS type name: rcl_interfaces::srv::dds_::DescribeParameters_Response_

    """

    descriptors: List[ParameterDescriptor] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_f78abb00c23f3de0d89855f2fde1edf956df5996848e9bdf2c1800ee577b0188"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::DescribeParameters_Response_"
    ...
    def to_dict(self) -> dict:
        ...
        result['descriptors'] = [item.to_dict() for item in self.descriptors]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'descriptors' in data:
            ...
            kwargs['descriptors'] = [ParameterDescriptor.from_dict(item) for item in data['descriptors']]
...
class DescribeParameters:
    """
    Service type for rcl_interfaces/DescribeParameters.
    ...
    TYPE_HASH = "RIHS01_aef3be368376d798b418e46e79149ab66c2c8798821bfade57b0811ceaa6de8a"
