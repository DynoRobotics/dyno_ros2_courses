"""
SetParameters service type.

Auto-generated from rcl_interfaces/srv/SetParameters.srv
"""
...
@dataclass
class SetParameters_Request(IdlStruct, typename="rcl_interfaces/SetParameters_Request"):

    """rcl_interfaces/SetParameters_Request message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_9eb2d758d28f6b07401615089eaa098d0b99bccab30781868d53852843753158


    DDS type name: rcl_interfaces::srv::dds_::SetParameters_Request_
    ...
    TYPE_HASH = "RIHS01_9eb2d758d28f6b07401615089eaa098d0b99bccab30781868d53852843753158"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::SetParameters_Request_"
...
@dataclass
class SetParameters_Response(IdlStruct, typename="rcl_interfaces/SetParameters_Response"):

    """rcl_interfaces/SetParameters_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_1257d3f0f73aae5ed0cf97358922edd4d3492b6e2aa968bf046b789e49db4883


    DDS type name: rcl_interfaces::srv::dds_::SetParameters_Response_

    """

    results: List[SetParametersResult] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_1257d3f0f73aae5ed0cf97358922edd4d3492b6e2aa968bf046b789e49db4883"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::srv::dds_::SetParameters_Response_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'results' in data:
            ...
            kwargs['results'] = [SetParametersResult.from_dict(item) for item in data['results']]
...
class SetParameters:
    """
    Service type for rcl_interfaces/SetParameters.
    ...
    TYPE_HASH = "RIHS01_f7ce9bf6362bca637da0c809c57a989d37bb939a119aaccf9a9b0c272bba433b"
