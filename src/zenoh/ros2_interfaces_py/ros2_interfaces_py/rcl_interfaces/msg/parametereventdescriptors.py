...
@dataclass
class ParameterEventDescriptors(IdlStruct, typename="rcl_interfaces/ParameterEventDescriptors"):

    """rcl_interfaces/ParameterEventDescriptors message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_9b0a6e3d9bb1f83857ed8cdb6c4db6e1575bdbd9b435b7da2273816c19dd633c


    DDS type name: rcl_interfaces::msg::dds_::ParameterEventDescriptors_
    ...
    TYPE_HASH = "RIHS01_9b0a6e3d9bb1f83857ed8cdb6c4db6e1575bdbd9b435b7da2273816c19dd633c"


    # DDS Type Name
    DDS_TYPE_NAME = "rcl_interfaces::msg::dds_::ParameterEventDescriptors_"
    ...
    def to_dict(self) -> dict:
        ...
        result['new_parameters'] = [item.to_dict() for item in self.new_parameters]



        result['changed_parameters'] = [item.to_dict() for item in self.changed_parameters]



        result['deleted_parameters'] = [item.to_dict() for item in self.deleted_parameters]
