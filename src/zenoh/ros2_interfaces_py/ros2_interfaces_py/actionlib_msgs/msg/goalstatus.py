...
@dataclass
class GoalStatus(IdlStruct, typename="actionlib_msgs/GoalStatus"):

    """actionlib_msgs/GoalStatus message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_c90c64230954d90ee079cbdd22a14bca3650b3d403f5cc3faf0eee992c6ae9ff


    DDS type name: actionlib_msgs::msg::dds_::GoalStatus_
    ...
    TYPE_HASH = "RIHS01_c90c64230954d90ee079cbdd22a14bca3650b3d403f5cc3faf0eee992c6ae9ff"


    # DDS Type Name
    DDS_TYPE_NAME = "actionlib_msgs::msg::dds_::GoalStatus_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'goal_id' in data:
            ...
            kwargs['goal_id'] = GoalID.from_dict(data['goal_id'])
