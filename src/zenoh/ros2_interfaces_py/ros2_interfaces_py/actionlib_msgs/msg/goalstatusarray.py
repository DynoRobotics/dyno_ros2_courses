...
@dataclass
class GoalStatusArray(IdlStruct, typename="actionlib_msgs/GoalStatusArray"):

    """actionlib_msgs/GoalStatusArray message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_fbf7b4b45cb1d87ef7031c23f98f2d3d6eea18494240d3391770c47dbe3be751


    DDS type name: actionlib_msgs::msg::dds_::GoalStatusArray_
    ...
    TYPE_HASH = "RIHS01_fbf7b4b45cb1d87ef7031c23f98f2d3d6eea18494240d3391770c47dbe3be751"


    # DDS Type Name
    DDS_TYPE_NAME = "actionlib_msgs::msg::dds_::GoalStatusArray_"
