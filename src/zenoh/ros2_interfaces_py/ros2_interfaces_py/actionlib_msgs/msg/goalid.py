...
@dataclass
class GoalID(IdlStruct, typename="actionlib_msgs/GoalID"):

    """actionlib_msgs/GoalID message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_140ea4a1bad4781edc32030c7983ab3a62c675f861c61c9b2200ae5e5398be24


    DDS type name: actionlib_msgs::msg::dds_::GoalID_
    ...
    TYPE_HASH = "RIHS01_140ea4a1bad4781edc32030c7983ab3a62c675f861c61c9b2200ae5e5398be24"


    # DDS Type Name
    DDS_TYPE_NAME = "actionlib_msgs::msg::dds_::GoalID_"
