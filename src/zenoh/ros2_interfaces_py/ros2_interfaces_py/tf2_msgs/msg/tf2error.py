...
@dataclass
class TF2Error(IdlStruct, typename="tf2_msgs/TF2Error"):

    """tf2_msgs/TF2Error message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_db2485e7d6a0ec75bf087e058ee45df682acc3a621ca7780503d10aac141809a


    DDS type name: tf2_msgs::msg::dds_::TF2Error_
    ...
    TYPE_HASH = "RIHS01_db2485e7d6a0ec75bf087e058ee45df682acc3a621ca7780503d10aac141809a"


    # DDS Type Name
    DDS_TYPE_NAME = "tf2_msgs::msg::dds_::TF2Error_"
    ...
    def to_dict(self) -> dict:
        ...
        result['error_string'] = self.error_string
    ...
    def from_dict(cls, data: dict):
        ...
        if 'error_string' in data:
            ...
            kwargs['error_string'] = data['error_string']
