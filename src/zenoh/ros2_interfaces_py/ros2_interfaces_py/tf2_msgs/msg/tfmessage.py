...
@dataclass
class TFMessage(IdlStruct, typename="tf2_msgs/TFMessage"):

    """tf2_msgs/TFMessage message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_1e6de7b021d480274692663f23edbafc2225f00ff1323a00c6538dda9cace658


    DDS type name: tf2_msgs::msg::dds_::TFMessage_

    """

    transforms: List['ros2_interfaces_py.geometry_msgs.msg.TransformStamped']

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_1e6de7b021d480274692663f23edbafc2225f00ff1323a00c6538dda9cace658"


    # DDS Type Name
    DDS_TYPE_NAME = "tf2_msgs::msg::dds_::TFMessage_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'transforms' in data:
            ...
            kwargs['transforms'] = [TransformStamped.from_dict(item) for item in data['transforms']]
