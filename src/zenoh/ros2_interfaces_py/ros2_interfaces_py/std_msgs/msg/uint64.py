...
class UInt64(IdlStruct, typename="std_msgs/UInt64"):
    ...
    ROS 2 type hash: RIHS01_fbdc52018fc13755dce18024d1a671c856aa8b4aaf63adfb095b608f98e8c943


    DDS type name: std_msgs::msg::dds_::UInt64_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::UInt64_"
