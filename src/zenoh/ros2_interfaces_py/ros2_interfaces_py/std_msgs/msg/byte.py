...
class Byte(IdlStruct, typename="std_msgs/Byte"):
    ...
    ROS 2 type hash: RIHS01_41e1a3345f73fe93ede006da826a6ee274af23dd4653976ff249b0f44e3e798f


    DDS type name: std_msgs::msg::dds_::Byte_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::Byte_"
