...
class String(IdlStruct, typename="std_msgs/String"):
    ...
    ROS 2 type hash: RIHS01_df668c740482bbd48fb39d76a70dfd4bd59db1288021743503259e948f6b1a18


    DDS type name: std_msgs::msg::dds_::String_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "std_msgs::msg::dds_::String_"
