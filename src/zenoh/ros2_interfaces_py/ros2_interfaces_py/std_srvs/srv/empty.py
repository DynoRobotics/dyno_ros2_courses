...
Auto-generated from std_srvs/srv/Empty.srv
"""
...
@dataclass
class Empty_Request(IdlStruct, typename="std_srvs/Empty_Request"):

    """std_srvs/Empty_Request message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_116f733b84bda91fa54c45c662be2d7cf4d54d2deb625c82ec450117d2876d84


    DDS type name: std_srvs::srv::dds_::Empty_Request_
    ...
    TYPE_HASH = "RIHS01_116f733b84bda91fa54c45c662be2d7cf4d54d2deb625c82ec450117d2876d84"


    # DDS Type Name
    DDS_TYPE_NAME = "std_srvs::srv::dds_::Empty_Request_"
...
@dataclass
class Empty_Response(IdlStruct, typename="std_srvs/Empty_Response"):

    """std_srvs/Empty_Response message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_1c85641ce8c6179b2ccb90382f8737596deadab55c3b9d07d4f69c2e5b52f9e9


    DDS type name: std_srvs::srv::dds_::Empty_Response_
    ...
    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_1c85641ce8c6179b2ccb90382f8737596deadab55c3b9d07d4f69c2e5b52f9e9"


    # DDS Type Name
    DDS_TYPE_NAME = "std_srvs::srv::dds_::Empty_Response_"
...
class Empty:
    """
    Service type for std_srvs/Empty.
    ...
    TYPE_HASH = "RIHS01_b3f444d7ded497288e6e7cc7ae6f5fc1168ea6565567d95f0dd905c524463597"
