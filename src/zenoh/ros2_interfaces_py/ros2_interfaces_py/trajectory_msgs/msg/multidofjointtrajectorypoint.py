...
@dataclass
class MultiDOFJointTrajectoryPoint(IdlStruct, typename="trajectory_msgs/MultiDOFJointTrajectoryPoint"):

    """trajectory_msgs/MultiDOFJointTrajectoryPoint message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_94b928115a9a3fb22a1f1337a61aa72fd2a1876ad1e9ea2ab5724e4681404a08


    DDS type name: trajectory_msgs::msg::dds_::MultiDOFJointTrajectoryPoint_

    """

    transforms: List['ros2_interfaces_py.geometry_msgs.msg.Transform']

    velocities: List['ros2_interfaces_py.geometry_msgs.msg.Twist']

    accelerations: List['ros2_interfaces_py.geometry_msgs.msg.Twist']
    ...
    TYPE_HASH = "RIHS01_94b928115a9a3fb22a1f1337a61aa72fd2a1876ad1e9ea2ab5724e4681404a08"


    # DDS Type Name
    DDS_TYPE_NAME = "trajectory_msgs::msg::dds_::MultiDOFJointTrajectoryPoint_"
    ...
    def to_dict(self) -> dict:
        ...
        result['transforms'] = [item.to_dict() for item in self.transforms]



        result['velocities'] = [item.to_dict() for item in self.velocities]



        result['accelerations'] = [item.to_dict() for item in self.accelerations]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'transforms' in data:
            ...
            kwargs['transforms'] = [Transform.from_dict(item) for item in data['transforms']]


        if 'velocities' in data:

            kwargs['velocities'] = [Twist.from_dict(item) for item in data['velocities']]


        if 'accelerations' in data:

            kwargs['accelerations'] = [Twist.from_dict(item) for item in data['accelerations']]
