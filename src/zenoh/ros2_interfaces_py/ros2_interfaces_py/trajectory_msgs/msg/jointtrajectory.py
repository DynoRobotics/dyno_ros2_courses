...
@dataclass
class JointTrajectory(IdlStruct, typename="trajectory_msgs/JointTrajectory"):

    """trajectory_msgs/JointTrajectory message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_87665f41bf506e1e855d358184269ef67ea6e60f2159a2ef0cf802bd7b339abc


    DDS type name: trajectory_msgs::msg::dds_::JointTrajectory_
    ...
    TYPE_HASH = "RIHS01_87665f41bf506e1e855d358184269ef67ea6e60f2159a2ef0cf802bd7b339abc"


    # DDS Type Name
    DDS_TYPE_NAME = "trajectory_msgs::msg::dds_::JointTrajectory_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'points' in data:
            ...
            kwargs['points'] = [JointTrajectoryPoint.from_dict(item) for item in data['points']]
