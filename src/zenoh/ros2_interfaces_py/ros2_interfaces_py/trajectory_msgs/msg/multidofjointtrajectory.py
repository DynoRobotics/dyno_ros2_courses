...
@dataclass
class MultiDOFJointTrajectory(IdlStruct, typename="trajectory_msgs/MultiDOFJointTrajectory"):

    """trajectory_msgs/MultiDOFJointTrajectory message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_69348a6e153b8882a1e87b0320779ec0d357fafb899623196174c9bf09f30aef


    DDS type name: trajectory_msgs::msg::dds_::MultiDOFJointTrajectory_
    ...
    TYPE_HASH = "RIHS01_69348a6e153b8882a1e87b0320779ec0d357fafb899623196174c9bf09f30aef"


    # DDS Type Name
    DDS_TYPE_NAME = "trajectory_msgs::msg::dds_::MultiDOFJointTrajectory_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'points' in data:
            ...
            kwargs['points'] = [MultiDOFJointTrajectoryPoint.from_dict(item) for item in data['points']]
