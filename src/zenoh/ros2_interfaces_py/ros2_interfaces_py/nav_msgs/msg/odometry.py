...
class Odometry(IdlStruct, typename="nav_msgs/Odometry"):
    ...
    ROS 2 type hash: RIHS01_cfb872d5784e1ef173562abd9359afb86411004a997e14763f51b3b6ffea1604


    DDS type name: nav_msgs::msg::dds_::Odometry_
    ...
    pose: 'ros2_interfaces_py.geometry_msgs.msg.PoseWithCovariance'

    twist: 'ros2_interfaces_py.geometry_msgs.msg.TwistWithCovariance'

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_cfb872d5784e1ef173562abd9359afb86411004a997e14763f51b3b6ffea1604"


    # DDS Type Name
    DDS_TYPE_NAME = "nav_msgs::msg::dds_::Odometry_"
    ...
    def to_dict(self) -> dict:
        ...
        result['child_frame_id'] = self.child_frame_id
        ...
        result['twist'] = self.twist.to_dict()
    ...
    def from_dict(cls, data: dict):
        ...
        if 'child_frame_id' in data:

            kwargs['child_frame_id'] = data['child_frame_id']
        ...
        if 'twist' in data:
            ...
            kwargs['twist'] = TwistWithCovariance.from_dict(data['twist'])
