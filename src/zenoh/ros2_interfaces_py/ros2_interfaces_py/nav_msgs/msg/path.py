...
class Path(IdlStruct, typename="nav_msgs/Path"):
    ...
    ROS 2 type hash: RIHS01_ef60d4323c52b6838bf27b170b0af735cf18c8f77d7ee536e1c888bfad658fd2


    DDS type name: nav_msgs::msg::dds_::Path_

    """

    header: 'ros2_interfaces_py.std_msgs.msg.Header'

    poses: List['ros2_interfaces_py.geometry_msgs.msg.PoseStamped']

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_ef60d4323c52b6838bf27b170b0af735cf18c8f77d7ee536e1c888bfad658fd2"


    # DDS Type Name
    DDS_TYPE_NAME = "nav_msgs::msg::dds_::Path_"
    ...
    def to_dict(self) -> dict:
        ...
        result['poses'] = [item.to_dict() for item in self.poses]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'poses' in data:
            ...
            kwargs['poses'] = [PoseStamped.from_dict(item) for item in data['poses']]
