...
@dataclass
class Goals(IdlStruct, typename="nav_msgs/Goals"):

    """nav_msgs/Goals message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_9cef8e9aa9bdd121b2ed1bd71acf2bf08103f017a5b9bebd077ea10d68550606


    DDS type name: nav_msgs::msg::dds_::Goals_

    """

    header: 'ros2_interfaces_py.std_msgs.msg.Header'

    goals: List['ros2_interfaces_py.geometry_msgs.msg.PoseStamped']

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_9cef8e9aa9bdd121b2ed1bd71acf2bf08103f017a5b9bebd077ea10d68550606"


    # DDS Type Name
    DDS_TYPE_NAME = "nav_msgs::msg::dds_::Goals_"
    ...
    def to_dict(self) -> dict:
        ...
        result['goals'] = [item.to_dict() for item in self.goals]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'goals' in data:
            ...
            kwargs['goals'] = [PoseStamped.from_dict(item) for item in data['goals']]
