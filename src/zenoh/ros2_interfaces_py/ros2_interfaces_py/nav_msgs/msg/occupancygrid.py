...
class OccupancyGrid(IdlStruct, typename="nav_msgs/OccupancyGrid"):
    ...
    ROS 2 type hash: RIHS01_db85a269c4734fbc643309ab12f04731200e391ddcec7b688a615944597fbf47


    DDS type name: nav_msgs::msg::dds_::OccupancyGrid_
    ...
    TYPE_HASH = "RIHS01_db85a269c4734fbc643309ab12f04731200e391ddcec7b688a615944597fbf47"


    # DDS Type Name
    DDS_TYPE_NAME = "nav_msgs::msg::dds_::OccupancyGrid_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'info' in data:
            ...
            kwargs['info'] = MapMetaData.from_dict(data['info'])
