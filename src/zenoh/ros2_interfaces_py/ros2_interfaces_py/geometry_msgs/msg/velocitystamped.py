...
@dataclass
class VelocityStamped(IdlStruct, typename="geometry_msgs/VelocityStamped"):

    """geometry_msgs/VelocityStamped message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_f0a424f4d8dd87585078b5248f5626b6caa18da329329b1ff879fc2ad9d93f4e


    DDS type name: geometry_msgs::msg::dds_::VelocityStamped_
    ...
    TYPE_HASH = "RIHS01_f0a424f4d8dd87585078b5248f5626b6caa18da329329b1ff879fc2ad9d93f4e"


    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::VelocityStamped_"
    ...
    def to_dict(self) -> dict:
        ...
        result['body_frame_id'] = self.body_frame_id



        result['reference_frame_id'] = self.reference_frame_id
    ...
    def from_dict(cls, data: dict):
        ...
        if 'body_frame_id' in data:

            kwargs['body_frame_id'] = data['body_frame_id']


        if 'reference_frame_id' in data:

            kwargs['reference_frame_id'] = data['reference_frame_id']


        if 'velocity' in data:

            kwargs['velocity'] = Twist.from_dict(data['velocity'])
