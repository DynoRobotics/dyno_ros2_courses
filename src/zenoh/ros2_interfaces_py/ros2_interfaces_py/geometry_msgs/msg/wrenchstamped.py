...
class WrenchStamped(IdlStruct, typename="geometry_msgs/WrenchStamped"):
    ...
    ROS 2 type hash: RIHS01_b8eb270725af9d3819c8e97dfc18ac160bde1b7677833381b04a3e6755537431


    DDS type name: geometry_msgs::msg::dds_::WrenchStamped_
    ...
    TYPE_HASH = "RIHS01_b8eb270725af9d3819c8e97dfc18ac160bde1b7677833381b04a3e6755537431"


    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::WrenchStamped_"
    ...
    def to_dict(self) -> dict:
        ...
        result['wrench'] = self.wrench.to_dict()
    ...
    def from_dict(cls, data: dict):
        ...
        if 'wrench' in data:
            ...
            kwargs['wrench'] = Wrench.from_dict(data['wrench'])
