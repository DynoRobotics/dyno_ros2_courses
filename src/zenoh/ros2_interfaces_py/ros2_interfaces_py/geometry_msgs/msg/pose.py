...
class Pose(IdlStruct, typename="geometry_msgs/Pose"):
    ...
    ROS 2 type hash: RIHS01_d501954e9476cea2996984e812054b68026ae0bfae789d9a10b23daf35cc90fa


    DDS type name: geometry_msgs::msg::dds_::Pose_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::Pose_"
    ...
    def from_dict(cls, data: dict):
        ...
        if 'position' in data:
            ...
            kwargs['position'] = Point.from_dict(data['position'])
