...
class InertiaStamped(IdlStruct, typename="geometry_msgs/InertiaStamped"):
    ...
    ROS 2 type hash: RIHS01_ef6d92746df97100371272fa42d4d4434b62bff125a53b27bb161375ea832ce1


    DDS type name: geometry_msgs::msg::dds_::InertiaStamped_
    ...
    TYPE_HASH = "RIHS01_ef6d92746df97100371272fa42d4d4434b62bff125a53b27bb161375ea832ce1"


    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::InertiaStamped_"
    ...
    def to_dict(self) -> dict:
        ...
        result['inertia'] = self.inertia.to_dict()
    ...
    def from_dict(cls, data: dict):
        ...
        if 'inertia' in data:
            ...
            kwargs['inertia'] = Inertia.from_dict(data['inertia'])
