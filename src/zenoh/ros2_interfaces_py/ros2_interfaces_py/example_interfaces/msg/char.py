...
@dataclass
class Char(IdlStruct, typename="example_interfaces/Char"):

    """example_interfaces/Char message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_fbcacba9afd0dba7e0f6e9cede2e2e0596f83a2b19f43c4275b70c2d7cdaa1f7


    DDS type name: example_interfaces::msg::dds_::Char_
    ...
    TYPE_HASH = "RIHS01_fbcacba9afd0dba7e0f6e9cede2e2e0596f83a2b19f43c4275b70c2d7cdaa1f7"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::Char_"
