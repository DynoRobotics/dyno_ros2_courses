...
@dataclass
class Byte(IdlStruct, typename="example_interfaces/Byte"):

    """example_interfaces/Byte message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_f014e0424be54b8ba7c35490aea4198be92df1de4e88f4e19a2fbbce2e020bb9


    DDS type name: example_interfaces::msg::dds_::Byte_
    ...
    TYPE_HASH = "RIHS01_f014e0424be54b8ba7c35490aea4198be92df1de4e88f4e19a2fbbce2e020bb9"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::Byte_"
