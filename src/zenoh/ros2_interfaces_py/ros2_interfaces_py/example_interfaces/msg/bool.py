...
@dataclass
class Bool(IdlStruct, typename="example_interfaces/Bool"):

    """example_interfaces/Bool message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_4765c142500f8fd4e1a32fb3edd7b7d9d822a16ec270445f5120e772c5f9aed5


    DDS type name: example_interfaces::msg::dds_::Bool_
    ...
    TYPE_HASH = "RIHS01_4765c142500f8fd4e1a32fb3edd7b7d9d822a16ec270445f5120e772c5f9aed5"


    # DDS Type Name
    DDS_TYPE_NAME = "example_interfaces::msg::dds_::Bool_"
