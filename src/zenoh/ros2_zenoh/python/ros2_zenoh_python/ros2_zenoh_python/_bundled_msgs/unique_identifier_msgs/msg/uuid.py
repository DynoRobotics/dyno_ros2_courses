...
@dataclass
class UUID(IdlStruct, typename="unique_identifier_msgs/UUID"):

    """unique_identifier_msgs/UUID message.
    
    Encoding: CDR

    ROS 2 type hash: RIHS01_1b8e8aca958cbea28fe6ef60bf6c19b683c97a9ef60bb34752067d0f2f7ab437
    ...
    uuid: array[uint8, 16] = field(default_factory=lambda: [0] * 16)
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "unique_identifier_msgs::msg::dds_::UUID_"
