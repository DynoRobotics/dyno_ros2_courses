...
class ChannelFloat32(IdlStruct, typename="sensor_msgs/ChannelFloat32"):
    ...
    ROS 2 type hash: RIHS01_92665437ddf39346f4ba39ee32e648390605b633cc077d40f4bd4d7b58af6cd4


    DDS type name: sensor_msgs::msg::dds_::ChannelFloat32_
    ...
    values: List[float32] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_92665437ddf39346f4ba39ee32e648390605b633cc077d40f4bd4d7b58af6cd4"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::ChannelFloat32_"
