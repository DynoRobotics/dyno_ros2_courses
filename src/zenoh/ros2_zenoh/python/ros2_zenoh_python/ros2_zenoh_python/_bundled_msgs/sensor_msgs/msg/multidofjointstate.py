...
class MultiDOFJointState(IdlStruct, typename="sensor_msgs/MultiDOFJointState"):
    ...
    ROS 2 type hash: RIHS01_4d4ded702cfba7ff3ec783835c1a1425f75e53939a430ff355d1fee4b3bbc40b


    DDS type name: sensor_msgs::msg::dds_::MultiDOFJointState_
    ...
    transforms: List[geometry_msgs_msg.Transform] = field(default_factory=list)

    twist: List[geometry_msgs_msg.Twist] = field(default_factory=list)

    wrench: List[geometry_msgs_msg.Wrench] = field(default_factory=list)

    

    # ROS2 Type Hash (RIHS01)
    TYPE_HASH = "RIHS01_4d4ded702cfba7ff3ec783835c1a1425f75e53939a430ff355d1fee4b3bbc40b"


    # DDS Type Name
    DDS_TYPE_NAME = "sensor_msgs::msg::dds_::MultiDOFJointState_"
    ...
    def to_dict(self) -> dict:
        ...
        result['twist'] = [item.to_dict() for item in self.twist]



        result['wrench'] = [item.to_dict() for item in self.wrench]
    ...
    def from_dict(cls, data: dict):
        ...
        if 'joint_names' in data:
            ...
            kwargs['joint_names'] = data['joint_names']


        if 'transforms' in data:

            
            kwargs['transforms'] = [geometry_msgs_msg.Transform.from_dict(item) for item in data['transforms']]
        ...
        if 'twist' in data:
            ...
            kwargs['twist'] = [geometry_msgs_msg.Twist.from_dict(item) for item in data['twist']]
        ...
        if 'wrench' in data:
            ...
            kwargs['wrench'] = [geometry_msgs_msg.Wrench.from_dict(item) for item in data['wrench']]
