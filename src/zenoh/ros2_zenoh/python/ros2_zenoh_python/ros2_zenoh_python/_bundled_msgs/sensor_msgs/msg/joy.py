...
class Joy(IdlStruct, typename="sensor_msgs/Joy"):
    ...
    ROS 2 type hash: RIHS01_0d356c79cad3401e35ffeb75a96a96e08be3ef896b8b83841d73e890989372c5
    ...
    axes: List[float32] = field(default_factory=list)

    buttons: List[int32] = field(default_factory=list)
