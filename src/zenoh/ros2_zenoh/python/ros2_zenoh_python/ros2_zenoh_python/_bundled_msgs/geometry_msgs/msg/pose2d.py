...
class Pose2D(IdlStruct, typename="geometry_msgs/Pose2D"):
    ...
    ROS 2 type hash: RIHS01_d68efa5b46e70f7b16ca23085474fdac5a44b638783ec42f661da64da4724ccc


    DDS type name: geometry_msgs::msg::dds_::Pose2D_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::Pose2D_"
