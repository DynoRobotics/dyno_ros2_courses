...
class Accel(IdlStruct, typename="geometry_msgs/Accel"):
    ...
    ROS 2 type hash: RIHS01_dc448243ded9b1fcbcca24aba0c22f013dae06c354ba2d849571c0a2a3f57ca0


    DDS type name: geometry_msgs::msg::dds_::Accel_
    ...
    # DDS Type Name
    DDS_TYPE_NAME = "geometry_msgs::msg::dds_::Accel_"
    ...
    def to_dict(self) -> dict:
        ...
        result['angular'] = self.angular.to_dict()
